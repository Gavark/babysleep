...
/** @typedef {{}} Baby_Form_Not_FoundInputs */

const fr_baby_form_not_found = /** @type {(inputs: Baby_Form_Not_FoundInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Bébé introuvable`)
};

const en_baby_form_not_found = /** @type {(inputs: Baby_Form_Not_FoundInputs) => LocalizedString} */ () => {
...
* | "Baby not found" |
*
* @param {Baby_Form_Not_FoundInputs} inputs
