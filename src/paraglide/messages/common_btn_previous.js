...
*/
const common_btn_previous = /** @type {((inputs?: Common_Btn_PreviousInputs, options?: { locale?: "fr" | "en" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Common_Btn_PreviousInputs, { locale?: "fr" | "en" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "fr") return fr_common_btn_previous(inputs)
	return en_common_btn_previous(inputs)
});
export { common_btn_previous as "common.btn.previous" }